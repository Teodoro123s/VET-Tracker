...
export const parseNextAppointment = (medicalRecord) => {
...
const calculateRelativeDate = (relativeText) => {
...
const extractReason = (recordText) => {
...
export const processMedicalRecordForAppointments = async (medicalRecord) => {
  try {
