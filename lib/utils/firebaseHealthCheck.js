...
export class FirebaseHealthCheck {
  ...
  static async checkReadWrite(userEmail?)  {
    try {
  ...
  static async checkTenantAccess(userEmail)  {
    try {
  ...
  static async runFullHealthCheck(userEmail?)  {
    const checks = {};
  ...
  static async diagnoseAndReport(userEmail?)  {
