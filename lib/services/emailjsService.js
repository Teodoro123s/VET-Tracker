...
const EMAILJS_VET_SERVICE_ID = extra.EMAILJS_VET_SERVICE_ID || process.env.EMAILJS_VET_SERVICE_ID || '';
const EMAILJS_VET_TEMPLATE_ID = extra.EMAILJS_VET_TEMPLATE_ID || process.env.EMAILJS_VET_TEMPLATE_ID || '';
const EMAILJS_VET_PUBLIC_KEY = extra.EMAILJS_VET_PUBLIC_KEY || process.env.EMAILJS_VET_PUBLIC_KEY || '';
    ...
    const response = await fetch('https://api.emailjs.com/api/v1.0/email/send', {
      ...
      body: JSON.stringify({
        ...
        template_params: {
          to_email: to,
          to_name: name,
          veterinarian_email: email,
          veterinarian_password: password
        }
      })
    });
