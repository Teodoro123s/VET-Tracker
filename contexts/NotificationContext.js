...
export function NotificationProvider({ children }) {
  ...
  const checkAppointments = async () => {
    try {
      ...
      appointments.forEach(appointment => {
        ...
        if (new Date(appointment.createdAt) > lastChecked) {
  ...
  return (
    <NotificationContext.Provider value={{ notifications, addNotification, markAsRead, markAllAsRead, unreadCount, checkAppointments }}>
      {children}
